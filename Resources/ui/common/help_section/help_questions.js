...
function help_questions()
{
	...
	var question0 = Ti.UI.createLabel({ text: "How do I view my child's profile", left: 5, top: 10, width: '90%', });
	var question1 = Ti.UI.createLabel({ text: "How do I add a new entry", left: 5, top: 10, width: '90%', });
	var question2 = Ti.UI.createLabel({ text: "How do I view a different child's records", left: 5, top: 10, width: '90%', });
		...
		switch(e.index) {
			case 0:
				var image = Ti.UI.createImageView({
					image: "help_questions/personalCard.png",
					top: 20,
					width: '50%',
					height: '50%',
				});
				var text = Ti.UI.createLabel({
					text: "On the main(records) page, simply tap your child's name at the bottom of the screen "+
							"and the page will scroll down to your child's Personal Card. This is a quick view of "+
							"your child's basic information. Click the Edit button to view and edit additional details about your child.",
					textAlign: 1,
					width: '95%',
					top: 20,
				});
			...
			case 1:
				...
				var text = Ti.UI.createLabel({
					text: "Simply click the New Entry button at the top of the Records page for the child. After that you can "+
			...
			case 2:
				var image = Ti.UI.createImageView({
					image: "help_questions/SE_logout.png",
					top: 20,
					width: '50%',
					height: '50%',
				});
				var text = Ti.UI.createLabel({
					text: "Simply click the Menu button on the top left of the main screen and you will see the menu. "+
							"This is where you can do many actions such as creating a new child profile or switching to a different "+
							"child. You can also Logout using this menu by tapping Logout",
					textAlign: 1,
					width: '95%',
					top: 20,
				});
